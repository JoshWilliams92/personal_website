...
import sjpLogo from '@/images/logos/sjp.svg'
import tealiumLogo from '@/images/logos/tealium.svg'
import serviceNowLogo from '@/images/logos/snow.svg'
import sapImage from '@/images/logos/sapImage.png'
import sjpImage from '@/images/logos/sjpImage.png'
import tealiumImage from '@/images/logos/tealiumImage.png'
import serviceNowImage from '@/images/logos/snowImage.png'
  ...
  let resume: Array<Role> = [
    {
      ...
      logo: sjpLogo,
      start: { label: 'Jul 2025', dateTime: '2025-07' },
    ...
    },
    {
      ...
      end: { label: 'Oct 2023', dateTime: '2023-10' },
    },
  ]
    ...
    <>
      <Container className="mt-15 sm:mt-30">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            With a strong foundation of corporate experience, I welcome freelance engagements of any scale—whether you need a streamlined website, a robust end-to-end platform, or innovative solutions leveraging AI, machine learning, or generative technologies. I am committed to delivering results tailored to your unique goals.
          </p>
